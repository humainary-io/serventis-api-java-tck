...
final class SymbolContractTest {
  ...
  @SpecRef({
    ...
    "registry:evals",
    "registry:exchanges", "registry:flows", "registry:guards", "registry:leases",
    "registry:members", "registry:messages", "registry:probes",
  ...
  void dimensionSetMembershipMatchesRegistry() {
    ...
    assertEquals(
      Map.ofEntries(
        ...
        Map.entry("Guards", List.of("IDENTITY", "PERMISSION")),
        Map.entry("Leases", List.of("LESSOR", "LESSEE")),
        Map.entry("Members", List.of("SELF", "PEER")),
        Map.entry("Messages", List.of("PRODUCER", "BROKER", "CONSUMER")),
  ...
  void sharedSignLexemesMatchRegistry() {
    ...
    assertEquals(
      Map.ofEntries(
        ...
        Map.entry("ATTEMPT", List.of("Atomics", "Guards", "Locks", "Resources")),
        Map.entry("CONTRACT", List.of("Exchanges", "Pools", "Valves")),
        Map.entry("DELIVER", List.of("Actors", "Messages")),
        Map.entry("DENY", List.of("Actors", "Guards", "Leases", "Locks", "Resources", "Valves")),
        Map.entry("DISCONNECT", List.of("Probes", "Services")),
        Map.entry("DROP", List.of("Routers", "Valves")),
        Map.entry("EVICT", List.of("Caches", "Members")),
        Map.entry("EXHAUST", List.of("Atomics", "Messages")),
        Map.entry("EXPAND", List.of("Pools", "Valves")),
        Map.entry("EXPIRE", List.of("Caches", "Leases", "Messages", "Services", "Transactions")),
        Map.entry(
          "FAIL",
          List.of(
            "Atomics", "Changes", "Evals", "Flows", "Outcomes", "Probes", "Processes", "Services",
            "Tasks"
          )
        ),
        Map.entry("GRANT", List.of("Guards", "Leases", "Locks", "Resources")),
        ...
        Map.entry("PROGRESS", List.of("Changes", "Tasks")),
        Map.entry("PROMISE", List.of("Actors", "Agents")),
        Map.entry("REJECT", List.of("Changes", "Services", "Tasks")),
        ...
        Map.entry("START", List.of("Changes", "Processes", "Services", "Tasks", "Transactions")),
  ...
  @SpecRef({
    ...
    "registry:changes", "registry:counters", "registry:evals", "registry:exchanges",
    "registry:flows", "registry:gauges", "registry:guards", "registry:latches", "registry:leases",
    "registry:locks", "registry:logs", "registry:members", "registry:messages",
  ...
  void signSetMembershipMatchesRegistry() {
    ...
    assertEquals(
      Map.ofEntries(
        ...
        Map.entry("Changes", List.of("START", "APPLY", "FAIL", "REJECT", "REVERT", "PROGRESS")),
        ...
        Map.entry("Guards", List.of("ATTEMPT", "CHALLENGE", "GRANT", "DENY")),
        ...
        Map.entry(
          "Members",
          List.of("JOIN", "LEAVE", "SUSPECT", "REFUTE", "EVICT", "ELECT", "RESIGN")
        ),
        Map.entry(
          "Messages",
          List.of("PUBLISH", "DELIVER", "ACK", "NACK", "REDELIVER", "EXHAUST", "EXPIRE")
        ),
