...
2. **The published Humainary artifacts are Maven-resolvable.** The defaults are:
    ...
    - `io.humainary.serventis:humainary-serventis-api:3.6.0` — the Serventis API
    ...
    - `io.humainary.testkit:humainary-substrates-api-tck:3.6.0` (`test-jar`) — the shared test
